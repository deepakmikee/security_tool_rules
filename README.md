...
This repo contains the rulesets i write for different custom usecases. It covers different tools like semgrep, falco and the custom usecases. 
If you are using semgrep as part of CI/CD security and if you find any issues not being detected by semgrep you can write your own custom rule that helps to detect those issues in your code
Few Usecases are:- 
